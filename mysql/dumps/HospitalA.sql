...
--
-- Host: localhost    Database: HospitalA
-- ------------------------------------------------------
...
INSERT INTO `doctor_credentials` VALUES ('987654321','$2a$10$AYLPtYbiVMShq/w6k6oftOagQACoAl7VEmduE2ZIgnsgPkxH9HfAy');
...
INSERT INTO `doctor_details` VALUES ('987654321','IIITB','blr',NULL,'shrey@gmail.com','kauveri','male','tripathi','9327232276','karnataka');
...
--
-- Table structure for table `ehr_seq`
--

DROP TABLE IF EXISTS `ehr_seq`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ehr_seq` (
  `next_val` bigint(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ehr_seq`
--

LOCK TABLES `ehr_seq` WRITE;
/*!40000 ALTER TABLE `ehr_seq` DISABLE KEYS */;
INSERT INTO `ehr_seq` VALUES (51);
/*!40000 ALTER TABLE `ehr_seq` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-05-11  0:44:57
